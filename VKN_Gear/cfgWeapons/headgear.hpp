...
// Caps in black (vkn Logo)
  class VKN_cap_front_black: VKN_cap_front_base{
    author="Shagger";
    scope = 2;
  ...
  class VKN_cap_back_black: VKN_cap_back_base {
    author="Shagger";
    scope = 2;
...
// caps in Sand (vkn Logo)
  class VKN_cap_front_sand: VKN_cap_front_base{
    author="Shagger";
    scope = 2;
  ...
  class VKN_cap_back_sand: VKN_cap_back_base {
    author="Shagger";
    scope = 2;
