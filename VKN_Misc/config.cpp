...
#include "\VKN_Misc\Misc\cameraSettings.hpp"
class CfgVehicles
{
    class Man;
    class CAManBase : Man
        ...
        class LoadingStart : RscControlsGroup
        {
            class controls
            {
                ...
                class Viking_Logo : RscPictureKeepAspect
                {
                    ...
                    x = 0.066875 * safezoneW;
                    y = 0.236 * safezoneH;
                    w = 0.288750 * safezoneW;
                    h = 0.528 * safezoneH;
                };
...
#include "\vkn_misc\displays\3PPCameraAdjustment.hpp"
