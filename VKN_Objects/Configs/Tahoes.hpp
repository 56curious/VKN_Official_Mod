...
class VKN_tahoe_UNM_PMC_01: tahoe_UNM {
	...
	class EventHandlers: EventHandlers {
		init = "_this execVM '\VKN_Objects\Vehicles\tahoe_08\siren.sqf';";
	};
	...
	*/
		class code_1 {
			displayName = "<t color='#ffd800'>Code 1 [NUM1]</t>";
			displayNameDefault = "";
			position = "drivewheel";
			radius = 1;
			condition = "(driver this) isEqualTo player";
			statement = "this setVariable ['Code2', 1, true]; this setVariable ['Code3', 1, true]; this setVariable ['VKN_Siren', 0, true]; this execVM '\VKN_Objects\Vehicles\tahoe_08\code2Off.sqf'; this execVM '\VKN_Objects\Vehicles\tahoe_08\beaconsOff.sqf';";
			onlyForplayer = 0;
			shortcut = "LookLeftDown";
			showWindow = 0;
		};
		class code_2 {
			displayName = "<t color='#ffd800'>Code 2 [NUM2]</t>";
			displayNameDefault = "";
			position = "drivewheel";
			radius = 1;
			condition = "((driver this) isEqualTo player) && ((this getVariable ['code2', 0]) == 1)";
			statement = "this setVariable ['code2', 0, true]; this setVariable ['code3', 0, true]; this setVariable ['VKN_Siren', 0, true]; this execVM '\VKN_Objects\Vehicles\tahoe_08\code2On.sqf'; this execVM '\VKN_Objects\Vehicles\tahoe_08\beaconsOn.sqf';";
			onlyForplayer = 0;
			shortcut = "LookDown";
			showWindow = 0;
		};
		class code_3 {
			displayName = "<t color='#ffd800'>Code 3 [NUM3]</t>";
			displayNameDefault = "";
			position = "drivewheel";
			radius = 1;
			condition = "((driver this) isEqualTo player) && ((this getVariable ['code3', 0]) == 1)";
			statement = "this setVariable ['code3', 0, true]; this setVariable ['code2', 0, true]; this setVariable ['VKN_Siren', 1, true]; this execVM '\VKN_Objects\Vehicles\tahoe_08\code2On.sqf'; this execVM '\VKN_Objects\Vehicles\tahoe_08\beaconsOn.sqf';";
			onlyForplayer = 0;
