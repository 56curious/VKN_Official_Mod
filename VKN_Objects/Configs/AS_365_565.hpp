class AS_365: AS_365_base {
  scope = 0;
  soundEngineOnInt[]={"\VKN_Objects\Vehicles\as_365\data\Startup_Int.ogg",0.31622776,1};
  soundEngineOnExt[]={"\VKN_Objects\Vehicles\as_365\data\Startup_Ext.ogg",2.2387211,1,600};
  ...
  class Sounds {
    class EngineExt {
      sound[]={"\VKN_Objects\Vehicles\as_365\data\EngineLoop_ext.ogg",1.2589254,1,900};
      frequency="rotorSpeed";
      volume="camPos*(rotorSpeed-0.72)*4";
    };
    class RotorExt {
      sound[]={"\VKN_Objects\Vehicles\as_365\data\EngineLoop_ext.ogg",1.7782794,1,2000};
    ...
    class EngineInt {
      sound[]={"\VKN_Objects\Vehicles\as_365\data\EngineLoop_int.ogg",1,	1};
      frequency="rotorSpeed";
      volume="(1-camPos)*(rotorSpeed-0.75)*4";
    };
    class RotorInt {
      sound[]={"\VKN_Objects\Vehicles\as_365\data\EngineLoop_int.ogg",1.2589254,1};
      frequency="rotorSpeed * rotorSpeed * (1 - rotorThrust/6)";
