...
publicVariable "list_car_emp";publicVariable "static_turrets_emp";publicVariable "list_light_emp";publicVariable "special_helmet_emp";publicVariable "special_launchers_emp";