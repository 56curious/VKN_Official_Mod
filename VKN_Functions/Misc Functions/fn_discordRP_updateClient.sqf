...
while {true} do {
        ...
        
        {
            ...
            switch (str _x) do {
                case ("Display #4"): {
                    ...
                    _newState = format ["Status: %1 | Playing at: %2 on %3", call _fnc_CheckState, if (serverName == "") then {
                        "Server Unknown"
                    } else {
                        serverName
                    }, worldName];
    ...
    sleep 5;
    // temp until the display detection system is made
};