...
if (_viz_eff) then {
    ...
    [_ripple] spawn {
        ...
        sleep 1;deletevehicle _de_sters
    };
    ...
    // _light_emp setLightUseFlare false;
    _light_emp setLightFlaresize 0.1;	_light_emp setLightFlareMaxDistance 2000;
...
if (_player_viz) then {
    ...
    "filmGrain" ppEffectAdjust [0.35, 1, 1.5, 0.1, 1, false];
